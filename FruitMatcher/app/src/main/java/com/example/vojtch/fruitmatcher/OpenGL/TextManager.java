...
public class TextManager {
    ...
    public void AddCharRenderInformation(float[] vertices, float[] color, float[] uvCoordinates, short[] indices)
    {
        ...
        {
            this.indices[index_indices] = (short) (base + indices[j]);
            index_indices++;
        }
    }
    ...
    public void Draw(float[] m)
    {
        ...
        int mPositionHandle = GLES20.glGetAttribLocation(Shader.getTextShader(),
                "vPosition");
        ...
        int mTexCoordLoc = GLES20.glGetAttribLocation(Shader.getTextShader(),
                "a_texCoord" );
        ...
        int mColorHandle = GLES20.glGetAttribLocation(Shader.getTextShader(),
                "a_Color");
        ...
        int mtrxhandle = GLES20.glGetUniformLocation(Shader.getTextShader(),
                "uMVPMatrix");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mtrxhandle, 1, false, m, 0);

        int mSamplerLoc = GLES20.glGetUniformLocation (Shader.getTextShader(),
                "s_texture" );
    ...
    private void convertTextToTriangleInfo(TextObject val)
    {
        ...
        float x = val.getPosition().x;
        float y = val.getPosition().y;
